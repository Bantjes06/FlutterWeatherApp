  ...
  Future<WeatherModel> callWeatherAPi(bool current, String cityName) async {
    try {
      ...
      var url = Uri.https('api.openweathermap.org', '/data/2.5/weather',
          {'q': cityName, "units": "metric", "appid": '351524ce6ad92e365af96adbd0761cfd'});
...
class CallForecastToApi {
  Future<ForecastModel> callWeatherAPi(bool current, String cityName) async {
    try {
      Position currentPosition = await getCurrentPosition();
